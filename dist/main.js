...
*/ !(function () {
  ...
  function (e, t, n) {
    ...
    o.push([
      e.i,
      '.App-module__App__3M_RZ{width:100%;height:100%;min-height:100vh;display:flex;flex-direction:column;justify-content:space-between}.App-module__Content__9RmT5{flex-grow:1;margin:33px 0}\n',
      '',
      {
        version: 3,
        ...
        names: [],
        mappings:
          'AAAA,wBACE,UAAW,CACX,WAAY,CACZ,gBAAiB,CACjB,YAAa,CACb,qBAAsB,CACtB,6BAA8B,CAC/B,4BAGC,WAAY,CACZ,aAAc',
        sourcesContent: [
      ...
      (o.locals = { App: 'App-module__App__3M_RZ', Content: 'App-module__Content__9RmT5' }),
      (t.a = o);
  },
  function (e, t, n) {
    'use strict';
    ...
    o.push([
      e.i,
      ".Header-module__Header__1qiY2{height:93px;background:#f5db13;box-shadow:0px 4px 16px rgba(1,28,64,0.2);color:#212121;font-family:Karla;font-style:normal;font-weight:normal;font-size:25px;line-height:29px}.Header-module__content__3VQro{width:100%;height:100%;max-width:1125px;margin:0 auto;display:flex;justify-content:space-between;align-items:center}.Header-module__logo__RPmCm{width:158px;height:63px;background:white}.Header-module__menu__2CFMI{display:flex;justify-content:flex-end;align-items:center}.Header-module__menu__2CFMI li{list-style:none;margin-right:66px}.Header-module__menu__2CFMI li:last-child{margin-right:0}.Header-module__link__4ebYS{position:relative;font-family:Karla;font-style:normal;font-weight:normal;font-size:25px;line-height:29px;text-decoration:none;color:#000000}.Header-module__active__1N9yZ::after{content:'';position:absolute;bottom:-16px;left:0;width:100%;height:0;border:2px solid #212121;border-radius:3px}\n",
      '',
      {
        version: 3,
        sources: ['webpack://src/components/Header/Header.module.scss', 'webpack://src/globalVariables.scss'],
        names: [],
        mappings:
          'AAEA,8BACE,WAAY,CACZ,kBCDkB,CDElB,yCCDgC,CDEhC,aAAc,CACd,iBAAkB,CAClB,iBAAkB,CAClB,kBAAmB,CACnB,cAAe,CACf,gBAAiB,CAClB,+BAGC,UAAW,CACX,WAAY,CACZ,gBCjBsB,CDkBtB,aAAc,CACd,YAAa,CACb,6BAA8B,CAC9B,kBAAmB,CACpB,4BAGC,WAAY,CACZ,WAAY,CAEZ,gBAAiB,CAElB,4BAGC,YAAa,CACb,wBAAyB,CACzB,kBAAmB,CAHrB,+BAMI,eAAgB,CAChB,iBAAkB,CAPtB,0CAUM,cAAe,CAChB,4BAKH,iBAAkB,CAClB,iBAAkB,CAClB,iBAAkB,CAClB,kBAAmB,CACnB,cAAe,CACf,gBAAiB,CACjB,oBAAqB,CACrB,aAAc,CACf,qCAIG,UAAW,CACX,iBAAkB,CAClB,YAAa,CACb,MAAO,CACP,UAAW,CACX,QAAS,CACT,wBC7DoB,CD8DpB,iBAAkB',
        sourcesContent: [
          "@import '../../globalVariables.scss';\n\n.Header {\n  height: 93px;\n  background: $colorThird;\n  box-shadow: 0px 4px 16px $colorShadow;\n  color: #212121;\n  font-family: Karla;\n  font-style: normal;\n  font-weight: normal;\n  font-size: 25px;\n  line-height: 29px;\n}\n\n.content {\n  width: 100%;\n  height: 100%;\n  max-width: $maxWidthDesktop;\n  margin: 0 auto;\n  display: flex;\n  justify-content: space-between;\n  align-items: center;\n}\n\n.logo {\n  width: 158px;\n  height: 63px;\n  // TODO: first add loader for svg\n  background: white;\n  // background: url('./img/logo.svg') no-repeat;\n}\n\n.menu {\n  display: flex;\n  justify-content: flex-end;\n  align-items: center;\n\n  & li {\n    list-style: none;\n    margin-right: 66px;\n\n    &:last-child {\n      margin-right: 0;\n    }\n  }\n}\n\n.link {\n  position: relative;\n  font-family: Karla;\n  font-style: normal;\n  font-weight: normal;\n  font-size: 25px;\n  line-height: 29px;\n  text-decoration: none;\n  color: #000000;\n}\n\n.active {\n  &::after {\n    content: '';\n    position: absolute;\n    bottom: -16px;\n    left: 0;\n    width: 100%;\n    height: 0;\n    border: 2px solid $colorParagraph;\n    border-radius: 3px;\n  }\n}\n",
          '$maxWidthDesktop: 1125px;\n\n// colors\n$colorThird: #f5db13;\n$colorShadow: rgba(1, 28, 64, 0.2);\n$colorParagraph: #212121;\n',
        ],
        sourceRoot: '',
      },
    ]),
      (o.locals = {
        Header: 'Header-module__Header__1qiY2',
  ...
  function (e, t, n) {
    ...
    o.push([
      e.i,
      '.Footer-module__Footer__1IeE-{width:100%;max-width:1125px;margin:0 auto 33px;display:flex;justify-content:space-between;color:#212121;font-family:Karla;font-style:normal;font-weight:bold;font-size:18px;line-height:21px}.Footer-module__label__13BGT{font-family:Karla;font-style:normal;font-weight:bold;font-size:18px;line-height:21px;color:#212121}.Footer-module__link__2LsB4{text-decoration:none;font-family:Karla;font-style:normal;font-weight:bold;font-size:18px;line-height:21px;color:#212121}\n',
      '',
      {
        version: 3,
        sources: ['webpack://src/components/Footer/Footer.module.scss', 'webpack://src/globalVariables.scss'],
        names: [],
        mappings:
          'AAEA,8BACE,UAAW,CACX,gBCJsB,CDKtB,kBAAmB,CACnB,YAAa,CACb,6BAA8B,CAC9B,aAAc,CACd,iBAAkB,CAClB,iBAAkB,CAClB,gBAAiB,CACjB,cAAe,CACf,gBAAiB,CAClB,6BAGC,iBAAkB,CAClB,iBAAkB,CAClB,gBAAiB,CACjB,cAAe,CACf,gBAAiB,CACjB,aCjBsB,CDkBvB,4BAGC,oBAAqB,CACrB,iBAAkB,CAClB,iBAAkB,CAClB,gBAAiB,CACjB,cAAe,CACf,gBAAiB,CACjB,aC3BsB',
        sourcesContent: [
      ...
      (o.locals = {
        Footer: 'Footer-module__Footer__1IeE-',
  ...
  function (e, t, n) {
    ...
    o.push([
      ...
      '',
      {
        ...
        names: [],
        mappings: 'AAAA;EACE,UAAU;EACV,SAAS;AACX;;AAEA;EACE,6DAA6D;AAC/D',
        sourcesContent: [
          '* {\n  padding: 0;\n  margin: 0;\n}\n\nbody {\n  background: linear-gradient(180deg, #f5db13 0%, #f2b807 100%);\n}\n',
        ],
        sourceRoot: '',
...
*/ var r = Object.getOwnPropertySymbols,
  ...
  function (e, t, n) {
    ...
    var l = r(n(3)),
      a = r(n(12)),
      o = r(n(16));
    n(22), a.default.render(l.default.createElement(o.default), document.getElementById('root'));
  },
  function (e, t, n) {
    'use strict';
    ...
    function A(e, t, n, r, o) {
          ...
          Array.isArray(o)
            ...
            : null != o &&
              (E(o) &&
                ...
                })(o, n + (!o.key || (u && u.key === o.key) ? '' : ('' + o.key).replace(S, '$&/') + '/') + e)),
              t.push(o)),
          1
        );
      if (((u = 0), (r = '' === r ? '.' : r + ':'), Array.isArray(e)))
        ...
        for (e = c.call(e), s = 0; !(i = e.next()).done; ) u += A((i = i.value), t, n, (c = r + x(i, s++)), o);
      else if ('object' === i)
        throw (
          ((t = '' + e),
    ...
    (t.Children = {
      ...
      (t.cloneElement = function (e, t, n) {
        ...
        if (null != t) {
          ...
          for (c in t) k.call(t, c) && !C.hasOwnProperty(c) && (a[c] = void 0 === t[c] && void 0 !== s ? s[c] : t[c]);
        }
  ...
  function (e, t, n) {
    ...
    function Ne(e) {
      if ((e = Zr(e))) {
        ...
        var t = e.stateNode;
        t && ((t = el(t)), xe(e.stateNode, e.type, t));
      }
    }
    function Be(e) {
    ...
    function Te() {
      if (Ae) {
        var e = Ae,
          t = Pe;
        if (((Pe = Ae = null), Ne(e), t)) for (e = 0; e < t.length; e++) Ne(t[e]);
      }
    }
    function ze(e, t) {
      return e(t);
    ...
    f &&
      ...
      'AnimationEvent' in window ||
        (delete _t.animationend.animation, delete _t.animationiteration.animation, delete _t.animationstart.animation),
    ...
    var Mn = f && 'TextEvent' in window && !On,
      Rn = f && (!Ln || (On && 8 < On && 11 >= On)),
    ...
    function Ar(e) {
      e[xr] ||
        ...
        i.forEach(function (t) {
          Cr.has(t) || Pr(t, !1, e, null), Pr(t, !0, e, null);
        }));
    }
    function Pr(e, t, n, r) {
      ...
      !(function (e, t, n) {
        ...
        e: {
          ...
          if (void 0 !== i) {
            ...
            for (var p, h = r; null !== h; ) {
              var m = (p = h).stateNode;
              if (
                (5 === p.tag && null !== m && ((p = m), null !== d && null != (m = Ie(h, d)) && c.push(Tr(h, m, p))), f)
              )
                break;
              h = h.return;
            }
        ...
        if (0 == (7 & t)) {
          if (
            ...
            null !== u && Or(o, i, u, c, !1), null !== s && null !== f && Or(o, f, s, c, !0);
          }
          if (
          ...
          b &&
            (Rn &&
              ...
              (Un || 'onCompositionStart' !== b
                ...
                : ((en = 'value' in (Jt = l) ? Jt.value : Jt.textContent), (Un = !0))),
            0 < (v = zr(r, b)).length &&
    ...
    function zr(e, t) {
      for (var n = t + 'Capture', r = []; null !== e; ) {
        ...
        5 === l.tag &&
          null !== a &&
          ((l = a), null != (a = Ie(e, n)) && r.unshift(Tr(e, a, l)), null != (a = Ie(e, t)) && r.push(Tr(e, a, l))),
          (e = e.return);
      }
      return r;
    }
    ...
    function Or(e, t, n, r, l) {
      for (var a = t._reactName, o = []; null !== n && n !== r; ) {
        ...
        5 === i.tag &&
          null !== s &&
          ((i = s),
          l ? null != (u = Ie(n, a)) && o.unshift(Tr(n, u, i)) : l || (null != (u = Ie(n, a)) && o.push(Tr(n, u, i)))),
          (n = n.return);
      }
    ...
    function vl(e, t, n) {
      ...
      n ? ((e = ml(e, t, cl)), (r.__reactInternalMemoizedMergedChildContext = e), al(sl), al(ul), ol(ul, e)) : al(sl),
        ol(sl, n);
    }
    var yl = null,
      bl = null,
    ...
    function $l() {
      if (!Rl && null !== Ol) {
        ...
        try {
          ...
          throw (null !== Ol && (Ol = Ol.slice(e + 1)), kl(Al, Vl), t);
        } finally {
          Rl = !1;
        }
      }
    ...
    function ga(e, t, n, r) {
      ...
      'object' == typeof a && null !== a
        ? (l.context = ta(a))
        : ((a = dl(t) ? cl : ul.current), (l.context = fl(e, a))),
        ua(e, n, l, r),
    ...
    function wa(e) {
      ...
      function s(e, t, n, r) {
        return null !== t && t.elementType === n.type
          ...
          : (((r = ju(n.type, n.key, n.props, null, e.mode, r)).ref = ya(e, t, n)), (r.return = e), r);
      }
      function c(e, t, n, r) {
        return null === t ||
          4 !== t.tag ||
      ...
      function d(e, t, n) {
        ...
        if ('object' == typeof t && null !== t) {
          ...
          if (va(t) || H(t)) return ((t = Uu(t, e.mode, n, null)).return = e), t;
          ba(e, t);
        }
        return null;
      }
      function p(e, t, n, r) {
        ...
        if ('object' == typeof n && null !== n) {
          switch (n.$$typeof) {
            case C:
              return n.key === l ? (n.type === E ? f(e, t, n.props.children, r, l) : s(e, t, n, r)) : null;
            case _:
              return n.key === l ? c(e, t, n, r) : null;
          }
          if (va(n) || H(n)) return null !== l ? null : f(e, t, n, r, null);
          ba(e, n);
        }
        return null;
      }
          ...
          switch (r.$$typeof) {
            case C:
              return (
                ...
                r.type === E ? f(t, e, r.props.children, l, r.key) : s(t, e, r, l)
              );
            case _:
              return c(t, (e = e.get(null === r.key ? n : r.key) || null), r, l);
          }
          if (va(r) || H(r)) return f(t, (e = e.get(n) || null), r, l, null);
          ba(t, r);
        }
        return null;
      }
            ...
            case C:
              e: {
                ...
                a.type === E
                  ...
                  : (((u = ju(a.type, a.key, a.props, null, e.mode, u)).ref = ya(e, r, a)), (u.return = e), (e = u));
              }
              return i(e);
            case _:
              e: {
    ...
    function Pa(e, t) {
      switch ((ol(xa, t), ol(Sa, e), ol(Ea, _a), (e = t.nodeType))) {
        case 9:
        case 11:
        ...
        if (t) {
          ...
          if (!Fa(e, t)) {
            if (!(t = Vr(n.nextSibling)) || !Fa(e, t))
              return (e.flags = (-1025 & e.flags) | 2), (Ra = !1), void (Oa = e);
            Da(Oa, n);
          }
          (Oa = e), (Ma = Vr(t.firstChild));
        } else (e.flags = (-1025 & e.flags) | 2), (Ra = !1), (Oa = e);
      }
    }
    function ja(e) {
    ...
    function Ua(e) {
      ...
      if (5 !== e.tag || ('head' !== t && 'body' !== t && !Ir(t, e.memoizedProps)))
        for (t = Ma; t; ) Da(e, t), (t = Vr(t.nextSibling));
      if ((ja(e), 13 === e.tag)) {
      ...
      } else Ma = Oa ? Vr(e.stateNode.nextSibling) : null;
      return !0;
    }
    function Ha() {
      (Ma = Oa = null), (Ra = !1);
    ...
    function to(e, t, n, r, l, a) {
      if (
        ...
        (t.updateQueue = null),
        (t.lanes = 0),
        (Wa.current = null === e || null === e.memoizedState ? Po : No),
        (e = n(r, l)),
        Za)
      ) {
        a = 0;
        do {
          ...
          (a += 1), (Xa = Ya = null), (t.updateQueue = null), (Wa.current = Bo), (e = n(r, l));
        } while (Za);
      }
      if (((Wa.current = Ao), (t = null !== Ya && null !== Ya.next), (qa = 0), (Xa = Ya = Ka = null), (Ga = !1), t))
        throw Error(o(300));
      return e;
    }
    function no() {
      ...
      if (null !== l) {
        ...
        do {
          ...
          if ((qa & c) === c)
            ...
            null === u ? ((i = u = f), (a = r)) : (u = u.next = f), (Ka.lanes |= c), (Oi |= c);
          }
          s = s.next;
        } while (null !== s && s !== l);
        null === u ? (a = r) : (u.next = i),
    ...
    var Ao = {
      ...
      Po = {
        ...
        useTransition: function () {
          var e = co(!1),
            t = e[0];
          return po((e = So.bind(null, e[1]))), [e, t];
        },
    ...
    function Mo(e, t, n, r, l, a) {
      ...
      return (
        ...
        0 == (l & a) && ((l = o.memoizedProps), (n = null !== (n = n.compare) ? n : ur)(l, r) && e.ref === t.ref)
          ? ei(e, t, a)
          : ((t.flags |= 1), ((e = Iu(o, r)).ref = t.ref), (e.return = t), (t.child = e))
      );
    }
    ...
    function Uo(e, t, n, r, l, a) {
      ...
      return (
        (t.flags |= 1),
        null !== e && o ? ((t.child = ka(t, e.child, null, a)), (t.child = ka(t, null, i, a))) : Lo(e, t, i, a),
    ...
    function Ko(e, t, n, r) {
      ...
      return (
        ...
        0 == (2 & l) && null !== a ? ((a.childLanes = 0), (a.pendingProps = t)) : (a = Hu(t, l, 0, null)),
        (n = Uu(n, l, r, null)),
        (a.return = e),
        (n.return = e),
        (a.sibling = n),
    ...
    function Yo(e, t, n, r) {
      ...
      return (
        (e = l.sibling),
        (n = Iu(l, { mode: 'visible', children: n })),
    ...
    function Xo(e, t, n, r, l) {
      ...
      return (
        0 == (2 & a) && t.child !== o
          ...
          : (n = Iu(o, i)),
        null !== e ? (r = Iu(e, r)) : ((r = Uu(r, a, l, null)).flags |= 2),
        (r.return = t),
        (n.return = t),
        (n.sibling = r),
        (t.child = n),
    ...
    function Jo(e, t, n) {
      var r = t.pendingProps,
        l = r.revealOrder,
        a = r.tail;
      if ((Lo(e, t, r.children, n), 0 != (2 & (r = za.current)))) (r = (1 & r) | 2), (t.flags |= 64);
      else {
    ...
    function ei(e, t, n) {
      if ((null !== e && (t.dependencies = e.dependencies), (Oi |= t.lanes), 0 != (n & t.childLanes))) {
              ...
              for (var s in (_e(n, i), (e = null), i))
                i.hasOwnProperty(s) &&
                  ...
                  'children' === s
                    ...
                    : u.hasOwnProperty(s) && null != a && 'onScroll' === s && Sr('scroll', r));
              switch (n) {
                case 'input':
                  X(r), re(r, i, !0);
                  break;
              ...
              : ((r = null !== r),
                ...
                r &&
                  ...
                  ((null === e && !0 !== t.memoizedProps.unstable_avoidThisFallback) || 0 != (1 & za.current)
                    ? 0 === Ti && (Ti = 3)
                    : ((0 !== Ti && 3 !== Ti) || (Ti = 4),
                      null === xi || (0 == (134217727 & Oi) && 0 == (134217727 & Mi)) || fu(xi, Pi))),
                (r || n) && (t.flags |= 4),
                null)
          );
        case 4:
        ...
        case 19:
          ...
          if (((i = 0 != (64 & t.flags)), null === (s = r.rendering)))
            if (i) ti(r, !1);
              ...
              null !== r.tail && Fl() > Ii && ((t.flags |= 64), (i = !0), ti(r, !1), (t.lanes = 33554432));
            }
          else {
            if (!i)
              if (null !== (e = La(s))) {
                if (
                  ...
                  ti(r, !0),
                  null === r.tail && 'hidden' === r.tailMode && !s.alternate && !Ra)
                )
                  return null !== (t = t.lastEffect = r.lastEffect) && (t.nextEffect = null), null;
              } else
                2 * Fl() - r.renderingStartTime > Ii &&
                  1073741824 !== n &&
    ...
    function ri(e) {
      switch (e.tag) {
        ...
        case 3:
          if ((Na(), al(sl), al(ul), $a(), 0 != (64 & (t = e.flags)))) throw Error(o(285));
              ...
              if ('style' === f)
                ...
                'dangerouslySetInnerHTML' === f
                  ...
                  : 'suppressContentEditableWarning' !== f &&
                    'suppressHydrationWarning' !== f &&
                    (u.hasOwnProperty(f)
                      ? (null != c && 'onScroll' === f && Sr('scroll', e), i || s === c || (i = []))
    ...
    function ui(e, t, n) {
      ...
      return (
        null !== a &&
          ...
          (n.callback = function () {
            'function' != typeof r && (null === Wi ? (Wi = new Set([this])) : Wi.add(this), ai(0, t));
            var e = t.stack;
      ...
      switch (n.tag) {
        ...
        case 22:
          ...
          if (null !== (t = null !== (t = n.updateQueue) ? t.lastEffect : null)) {
            ...
            do {
              var l = e;
              (r = l.next), 0 != (4 & (l = l.tag)) && 0 != (1 & l) && (Bu(n, e), Nu(n, e)), (e = r);
            } while (e !== t);
          }
          return;
        case 1:
    ...
    function bi(e, t) {
      switch (t.tag) {
        ...
        case 12:
          return;
        case 13:
          return null !== t.memoizedState && ((Fi = Fl()), pi(t.child, !0)), void wi(t);
        case 19:
          return void wi(t);
        case 17:
          return;
    ...
    var Ui,
      ...
      lu = !1;
    function au() {
      return 0 != (48 & Si) ? Fl() : -1 !== eu ? eu : (eu = Fl());
    }
    function ou(e) {
      if (0 == (2 & (e = e.mode))) return 1;
      if (0 == (4 & e)) return 99 === Il() ? 1 : 2;
      if ((0 === tu && (tu = Li), 0 !== Wl.transition)) {
    ...
    function iu(e, t, n) {
      ...
      Ht(e, t, n), e === xi && ((Mi |= t), 4 === Ti && fu(e, Pi));
      var r = Il();
      1 === t
        ? 0 != (8 & Si) && 0 == (48 & Si)
          ? du(e)
          : (su(e, n), 0 === Si && (ji(), Vl()))
        : (0 == (4 & Si) || (98 !== r && 99 !== r) || (null === Gi ? (Gi = new Set([e])) : Gi.add(e)), su(e, n)),
        (Di = e);
    }
    function uu(e, t) {
      e.lanes |= t;
    ...
    function su(e, t) {
      ...
      if (((r = Dt(e, e === xi ? Pi : 0)), (t = Mt), 0 === r))
        null !== n && (n !== zl && Cl(n), (e.callbackNode = null), (e.callbackPriority = 0));
      else {
        if (null !== n) {
        ...
        15 === t
          ? ((n = du.bind(null, e)), null === Ol ? ((Ol = [n]), (Ml = kl(Al, $l))) : Ol.push(n), (n = zl))
          : 14 === t
          ? (n = Hl(99, du.bind(null, e)))
          : (n = Hl(
              (n = (function (e) {
                switch (e) {
                  case 15:
    ...
    function cu(e) {
      if (((eu = -1), (nu = tu = 0), 0 != (48 & Si))) throw Error(o(327));
      var t = e.callbackNode;
      if (Pu() && e.callbackNode !== t) return null;
      var n = Dt(e, e === xi ? Pi : 0);
      if (0 === n) return null;
      var r = n,
        l = Si;
      Si |= 16;
      var a = bu();
      for ((xi === e && Pi === r) || (ji(), vu(e, r)); ; )
        try {
          Cu();
          break;
        } catch (t) {
      ...
      if ((Gl(), (_i.current = a), (Si = l), null !== Ai ? (r = 0) : ((xi = null), (Pi = 0), (r = Ti)), 0 != (Li & Mi)))
        vu(e, 0);
      else if (0 !== r) {
        if (
          (2 === r &&
            ((Si |= 64), e.hydrate && ((e.hydrate = !1), Hr(e.containerInfo)), 0 !== (n = Ft(e)) && (r = wu(e, n))),
          1 === r)
        )
          throw ((t = zi), vu(e, 0), fu(e, n), su(e, Fl()), t);
        switch (((e.finishedWork = e.current.alternate), (e.finishedLanes = n), r)) {
          ...
          case 2:
            ...
            break;
          case 3:
            if ((fu(e, n), (62914560 & n) === n && 10 < (r = Fi + 500 - Fl()))) {
              if (0 !== Dt(e, 0)) break;
      ...
      return su(e, Fl()), e.callbackNode === t ? cu.bind(null, e) : null;
    }
    function fu(e, t) {
      for (t &= ~Ri, t &= ~Mi, e.suspendedLanes |= t, e.pingedLanes &= ~t, e = e.expirationTimes; 0 < t; ) {
        var n = 31 - Vt(t),
          r = 1 << n;
        (e[n] = -1), (t &= ~r);
      }
    ...
    function du(e) {
      ...
      if ((Pu(), e === xi && 0 != (e.expiredLanes & Pi))) {
        var t = Pi,
          n = wu(e, t);
        0 != (Li & Mi) && (n = wu(e, (t = Dt(e, t))));
      } else n = wu(e, (t = Dt(e, 0)));
      if (
        (0 !== e.tag &&
          2 === n &&
          ((Si |= 64), e.hydrate && ((e.hydrate = !1), Hr(e.containerInfo)), 0 !== (t = Ft(e)) && (n = wu(e, t))),
        1 === n)
      )
        throw ((n = zi), vu(e, 0), fu(e, t), su(e, Fl()), n);
      return (e.finishedWork = e.current.alternate), (e.finishedLanes = t), Su(e), su(e, Fl()), null;
    }
    function pu(e, t) {
      var n = Si;
      Si |= 1;
    ...
    function vu(e, t) {
      ...
      if ((-1 !== n && ((e.timeoutHandle = -1), Ur(n)), null !== Ai))
      ...
      (xi = e), (Ai = Iu(e.current, null)), (Pi = Ni = Li = t), (Ti = 0), (zi = null), (Ri = Mi = Oi = 0);
    }
    function yu(e, t) {
      for (;;) {
        var n = Ai;
        try {
          if ((Gl(), (Wa.current = Ao), Ga)) {
          ...
          if (((qa = 0), (Xa = Ya = Ka = null), (Za = !1), (Ei.current = null), null === n || null === n.return)) {
            (Ti = 1), (zi = t), (Ai = null);
            break;
          }
          e: {
                ...
                case 1:
                  ...
                  if (
                    ...
                    ('function' == typeof k.getDerivedStateFromError ||
                      (null !== C && 'function' == typeof C.componentDidCatch && (null === Wi || !Wi.has(C))))
                  ) {
    ...
    function wu(e, t) {
      ...
      if ((Gl(), (Si = n), (_i.current = r), null !== Ai)) throw Error(o(261));
      return (xi = null), (Pi = 0), Ti;
    }
    function ku() {
      for (; null !== Ai; ) _u(Ai);
    }
    function Cu() {
      for (; null !== Ai && !_l(); ) _u(Ai);
    }
    function _u(e) {
      var t = Ui(e.alternate, e, Ni);
      (e.memoizedProps = e.pendingProps), null === t ? Eu(e) : (Ai = t), (Ei.current = null);
    }
    function Eu(e) {
      var t = e;
      do {
        ...
        if (((e = t.return), 0 == (2048 & t.flags))) {
          if (null !== (n = ni(n, t, Ni))) return void (Ai = n);
          if (
            (24 !== (n = t).tag && 23 !== n.tag) ||
            null === n.memoizedState ||
            0 != (1073741824 & Ni) ||
          ...
          if (null !== (n = ri(t))) return (n.flags &= 2047), void (Ai = n);
    ...
    function Su(e) {
      var t = Il();
      return Ul(99, xu.bind(null, e, t)), null;
    }
    function xu(e, t) {
      do {
        Pu();
      ...
      if (
        ...
        if (((l = Si), (Si |= 32), (Ei.current = null), (Rr = Kt), dr((i = fr())))) {
          if ('selectionStart' in i) u = { start: i.selectionStart, end: i.selectionEnd };
            ...
            e: if (
              ...
              t: for (;;) {
                ...
                for (;;) {
                  if (g === i) break t;
                  if ((v === u && ++h === a && (d = f), v === s && ++m === c && (p = f), null !== (y = g.nextSibling)))
                    break;
                  v = (g = v).parentNode;
                }
                g = y;
        ...
        (Dr = { focusedElem: i, selectionRange: u }), (Kt = !1), (ru = null), (lu = !1), (Hi = r);
        do {
          try {
            Au();
          } catch (e) {
        ...
        (Kt = !!Rr), (Dr = Rr = null), (e.current = n), (Hi = r);
        do {
          try {
            for (b = e; null !== Hi; ) {
              var _ = Hi.flags;
              if ((36 & _ && di(b, Hi.alternate, Hi), 128 & _)) {
                w = void 0;
                var E = Hi.ref;
                if (null !== E) {
                  var S = Hi.stateNode;
      ...
      if (Qi) (Qi = !1), (qi = e), (Ki = t);
        ...
        for (Hi = r; null !== Hi; )
          (t = Hi.nextEffect),
            (Hi.nextEffect = null),
            8 & Hi.flags && (((_ = Hi).sibling = null), (_.stateNode = null)),
            (Hi = t);
      if (
      ...
      if ((su(e, Fl()), Vi)) throw ((Vi = !1), (e = $i), ($i = null), e);
      return 0 != (8 & Si) || Vl(), null;
    }
    function Au() {
      for (; null !== Hi; ) {
        var e = Hi.alternate;
        lu ||
          null === ru ||
          (0 != (8 & Hi.flags) ? Je(Hi, ru) && (lu = !0) : 13 === Hi.tag && ki(e, Hi) && Je(Hi, ru) && (lu = !0));
        var t = Hi.flags;
        0 != (256 & t) && fi(e, Hi),
          0 == (512 & t) ||
            Qi ||
    ...
    function zu(e, t, n) {
      oa(e, (t = ii(0, (t = li(n, t)), 1))), (t = au()), null !== (e = uu(e, 1)) && (Ht(e, 1, t), su(e, t));
    }
    function Lu(e, t) {
      if (3 === e.tag) zu(e, e, t);
      else
        for (var n = e.return; null !== n; ) {
          ...
          if (1 === n.tag) {
            ...
            if (
              ...
              if ((oa(n, l), (l = au()), null !== (n = uu(n, 1)))) Ht(n, 1, l), su(n, l);
    ...
    function Ou(e, t, n) {
      ...
      null !== r && r.delete(t),
        ...
        xi === e &&
          (Pi & n) === n &&
          (4 === Ti || (3 === Ti && (62914560 & Pi) === Pi && 500 > Fl() - Fi) ? vu(e, 0) : (Ri |= n)),
        su(e, t);
    }
    function Mu(e, t) {
      var n = e.stateNode;
      null !== n && n.delete(t),
        0 === (t = 0) &&
          (0 == (2 & (t = e.mode))
            ...
            : 0 == (4 & t)
            ? (t = 99 === Il() ? 1 : 2)
            : (0 === tu && (tu = Li), 0 === (t = jt(62914560 & ~tu)) && (t = 4194304))),
        (n = au()),
      ...
      if (((r = e), 'function' == typeof e)) Fu(e) && (i = 1);
        ...
        e: switch (e) {
          ...
          case S:
            ...
            break;
          case x:
            return ((e = Du(12, n, t, 8 | l)).elementType = x), (e.type = x), (e.lanes = a), e;
          case B:
            return ((e = Du(13, n, t, l)).type = B), (e.elementType = B), (e.lanes = a), e;
          case T:
            return ((e = Du(19, n, t, l)).elementType = T), (e.lanes = a), e;
          case D:
            return Hu(n, l, a, t);
          case F:
            return ((e = Du(24, n, t, l)).elementType = F), (e.lanes = a), e;
          default:
      ...
      switch (((t.lanes = 0), t.tag)) {
          ...
          if (
            ...
            if (
              ((a = (l = t.stateNode).hydrate) &&
                ((Ma = Vr(t.stateNode.containerInfo.firstChild)), (Oa = t), (a = Ra = !0)),
              a)
            ) {
        ...
        case 5:
          return (
            ...
            (i = l.children),
            Ir(r, l) ? (i = null) : null !== a && Ir(r, a) && (t.flags |= 16),
            Fo(e, t),
            Lo(e, t, i, n),
            t.child
          );
        ...
        case 4:
          return (
            Pa(t, t.stateNode.containerInfo),
            (r = t.pendingProps),
            null === e ? (t.child = ka(t, null, r, n)) : Lo(e, t, r, n),
            t.child
          );
        case 11:
          return (r = t.type), (l = t.pendingProps), Oo(e, t, r, (l = t.elementType === r ? l : Ql(r, l)), n);
        case 7:
        ...
        case 14:
          return (a = Ql((l = t.type), t.pendingProps)), Mo(e, t, l, (a = Ql(l.type, a)), r, n);
        case 15:
    ...
    var ts = { Events: [Zr, Jr, el, Be, Te, Pu, { current: !1 }] },
  ...
  function (e, t, n) {
        ...
        if (n !== t) {
          ...
          e: for (var r = 0, l = e.length; r < l; ) {
            var a = 2 * (r + 1) - 1,
              ...
              u = e[i];
            if (void 0 !== o && 0 > x(o, n))
              void 0 !== u && 0 > x(u, o) ? ((e[r] = u), (e[i] = n), (r = i)) : ((e[r] = o), (e[a] = n), (r = a));
            else {
    ...
    function M(e) {
      for (var t = E(P); null !== t; ) {
        if (null === t.callback) S(P);
          ...
          S(P), (t.sortIndex = t.expirationTime), _(A, t);
        }
        t = E(P);
      }
    }
    ...
    function D(e, n) {
      ...
      var r = T;
      try {
        for (M(n), B = E(A); null !== B && (!(B.expirationTime > n) || (e && !t.unstable_shouldYield())); ) {
          var o = B.callback;
          if ('function' == typeof o) {
            (B.callback = null), (T = B.priorityLevel);
            var i = o(B.expirationTime <= n);
            (n = t.unstable_now()), 'function' == typeof i ? (B.callback = i) : B === E(A) && S(A), M(n);
          } else S(A);
          B = E(A);
        }
        if (null !== B) var u = !0;
    ...
    (t.unstable_IdlePriority = 5),
      ...
      (t.unstable_scheduleCallback = function (e, n, o) {
        ...
        return (
          ...
          o > i
            ? ((e.sortIndex = o), _(P, e), null === E(A) && e === E(P) && (O ? a() : (O = !0), l(R, o - i)))
            : ((e.sortIndex = u), _(A, e), L || z || ((L = !0), r(D))),
          e
        );
      }),
  ...
  function (e, t, n) {
    ...
    t.default = function () {
      return l.default.createElement(
        'div',
        { className: a.default(o.default.App) },
        l.default.createElement(i.default, null),
        l.default.createElement(
          'div',
          { className: a.default(o.default.Content) },
          'Yes, we did it! This is App Component Content!',
        ),
  ...
  function (e, t, n) {
    ...
    t.default = function () {
      return l.default.createElement(
        'div',
        { className: a.default(o.default.Header) },
        l.default.createElement(
          'div',
          { className: a.default(o.default.content) },
          l.default.createElement('div', { className: a.default(o.default.logo) }),
          l.default.createElement(
            'ul',
            { className: a.default(o.default.menu) },
            [
              ...
              return l.default.createElement(
                ...
                l.default.createElement(
                  'a',
                  {
                    className: a.default(o.default.link, ((n = {}), (n[o.default.active] = 0 === t), n)),
                    href: e.href,
                  },
                  e.label,
                ),
  ...
  function (e, t, n) {
    ...
    t.default = function () {
      return l.default.createElement(
        'div',
        { className: a.default(o.default.Footer) },
        l.default.createElement(
          'div',
          { className: a.default(o.default.label) },
          'Make with ',
          l.default.createElement('span', { role: 'img', 'aria-label': 'love', 'aria-labelledby': '' }, '❤️'),
        ),
        l.default.createElement(
          'a',
          { className: a.default(o.default.link), href: 'https://zarmarathon.com/' },
          'Ours Team',
        ),
      );
    };
